...
FUNCTION calc_entrainment(P_D, U_g, liquid_props, delta_L, C_f):
...
FUNCTION calc_heat_and_evaporation(T_L, Fr, gas_props, liquid_props, config, C_f):
    # 1. Radiation
