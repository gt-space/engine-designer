...
#sys.path.insert(0, '/Users/saakethramramoju/Library/CloudStorage/OneDrive-GeorgiaInstituteofTechnology/YJSP/Vespula Engine Dev/engine-designer-master/engineDesigner_v4.2')
import numpy as np
...
analysis_index = 10 # Axial station to analyze for 2D plots 
