...
np.savetxt('DARCYCONTOUR.txt', engine.engineContour, delimiter=' ', fmt='%s')


# ======================= Throat Insert  ============================
t_th = ablative.throat_insert_size(ablative.Graphite(),FOS=3)
...
R_CC = t_w+t_I+t_OW+CC_rad
OD_CC = 2*R_CC #m
#t_th = .5*.0254
#len_th = 3.5*.0254
mat_w= ablative.CarbonEpoxy()
mat_I=ablative.SilicaEpoxy()
mat_OW=ablative.CarbonEpoxy()
#mat_th= ablative.Graphite()
...
print("ENGINE CC Start OD [in]: " + str(OD_CC/.0254))
