...
#con_rat = 8.0 * D_t^-0.6 + 1.25 where D_t is in cm
con_rat = 6.6 #  Contraction ratio sized using correlation in code
...
# ======================= DESIGN INPUTS  ============================
liner=ablative.SilicaEpoxy()
I=ablative.SilicaEpoxy()
OW=ablative.CarbonEpoxy()
t_A_design = 1*.0254 # ablator thickness (m) # if this if ablator was used as insulation
Max_OW_temp = 550 #K
liner_idx = 0 # uses the initial combustion chamber properties # This should be throat at some point

minT= 3470 # this is just zooming in on a certain data regime essentially
