...
print("================================================================")
print("")
print(" +++ ABLATIVE ENGINE DESIGN RESULTS (Pre-Ablation) +++")
...
print("Throat Area [in^2]: " + str(engine.A_t/((.0254)**2)))
print("Throat Radius [in] " +str(engine.R_t/.0254))
...
print("Contraction Ratio: " + str(np.pi * engine.engineProps[0, 0]**2 / engine.A_t))
...
ablator = ablative.Ablator(ablative,ablator_mat,t_A_design=[])
...
ablative.run_liner_sizer(ablative,overwrap,insulator,ablator,t_A_design=t_A*.0254)
